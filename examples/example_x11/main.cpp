...
int main(int argc, char* argv[])
{
    ...
    XDefineCursor(g_display, g_window, XCreateFontCursor(g_display, 68));
    ...
    while (running)
    {
        ...
        else
        {
            ...
            // We are using ImGui as a window manager.
            // for every window we want to render, we need to call ImGui::Begin() and ImGui::End()
            ImGui_ImplX11_WindowManager_MakeEachWindow_ImGuiWindow();
...
void CreateX11Window()
{
    ...
    g_window = RootWindow(g_display, vi->screen);
